...
const MOCK_WORKERS = [
    { id: 1, name: "Jonny", skill: "Plumber", experience: "5 years", location: "Sector 10", rating: 4.8, reviewsCount: 120, verified: true },
    { id: 2, name: "Aditi", skill: "House Maid", experience: "8 years", location: "Downtown", rating: 5.0, reviewsCount: 350, verified: true },
    { id: 3, name: " Aditya Mehra", skill: "Electrician", experience: "3 years", location: "Sector 10", rating: 4.2, reviewsCount: 45, verified: false },
    { id: 4, name: "Yash  ", skill: "Carpenter", experience: "12 years", location: "Industrial Area(bihar)", rating: 4.5, reviewsCount: 88, verified: true },
    { id: 5, name: "Yaswant gupta", skill: "Cook (Chef)", experience: "6 years", location: "Downtown", rating: 4.9, reviewsCount: 210, verified: false },
    { id: 6, name: "Priyam rahi sri ", skill: "Driver", experience: "7 years", location: "Sector 10", rating: 3.9, reviewsCount: 61, verified: true },
];
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function applyLanguage(lang) {
        ...
        document.getElementById('worker-login-link').textContent = text.workerLogin;
        document.querySelector('a[href="#pricing-section"]').textContent = text.employerAccess;
        ...
        // How It Works
        document.querySelector('.bg-gray-50 h2').textContent = text.workflowTitle;

        document.querySelector('.lg\\:grid-cols-5 > div:nth-child(1) p:nth-child(2)').textContent = text.step1Title;
        document.querySelector('.lg\\:grid-cols-5 > div:nth-child(1) p:nth-child(3)').textContent = text.step1Text;

        document.querySelector('.lg\\:grid-cols-5 > div:nth-child(3) p:nth-child(2)').textContent = text.step2Title;
        document.querySelector('.lg\\:grid-cols-5 > div:nth-child(3) p:nth-child(3)').textContent = text.step2Text;

        document.querySelector('.lg\\:grid-cols-5 > div:nth-child(5) p:nth-child(2)').textContent = text.step3Title;
        document.querySelector('.lg\\:grid-cols-5 > div:nth-child(5) p:nth-child(3)').textContent = text.step3Text;

        document.querySelector('.lg\\:grid-cols-5 > div:nth-child(7) p:nth-child(2)').textContent = text.step4Title;
        document.querySelector('.lg\\:grid-cols-5 > div:nth-child(7) p:nth-child(3)').textContent = text.step4Text;
        ...
        // The workers list needs re-rendering to update "Chat Now" and "Call" buttons.
    ...
    trackButton.addEventListener('click', () => {
        ...
        if (jobId.startsWith('SS-123')) {
            statusMessage = `Job ID ${jobId}: Plumber Ram Lal has ACCEPTED your request and is en route. ETA: 30 mins.`;
            statusClass = 'bg-green-100 text-green-800 border-green-400 dark:bg-green-800 dark:text-green-200';
            icon = 'truck';
        } else if (jobId.startsWith('SS-999')) {
            statusMessage = `Job ID ${jobId}: Driver Ajay Verma's job is PENDING confirmation. We will notify you shortly.`;
